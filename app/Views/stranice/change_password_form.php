		...
		<div id="login">
			...
			<div class="login-form-content">
				<div class="login-form-header">
					<div class="logo">
                                            <a title = 'Kliknite za nocni rezim' href="<?php echo base_url();?>/index.php/User/promena_lozinke_noc"><img src="<?php echo base_url(); ?>/img/logo.png" height="80" width="100"></a>
					</div>
