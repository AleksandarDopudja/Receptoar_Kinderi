        ...
        <div class="login-form-container" id="login-form">
            <div class="login-form-contentNoc">
                <div class="login-form-header">
                    <div class="logo">
                        <a title = 'Kliknite za dnevni rezim' href="<?php echo base_url();?>/index.php/User_Authentication/prijava"><img src="<?php echo base_url(); ?>/img/logo.png" height="80" width="100"></a>
                    </div>
                    <font color='red'>
                    <?php
                        if (isset($message)) {
